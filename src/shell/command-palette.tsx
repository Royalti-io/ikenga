              ...
              <>
                ...
                {mode === 'all' && (
                  <Command.Group
                    ...
                    className="text-xs text-muted-foreground"
                  >
                    <PaletteItem onSelect={() => go('/mail/inbox')} Icon={Inbox} label="Go to Inbox" />
                    <PaletteItem onSelect={() => go('/mail/triage')} Icon={Inbox} label="Go to Triage" />
                    ...
                    />
                    <PaletteItem onSelect={() => go('/finance')} Icon={Wallet} label="Go to Finance" />
                    <PaletteItem
  ...
  return (
    <Command.Group heading="Open tabs" className="text-xs text-muted-foreground">
      {entries.map((entry) => {
        ...
        const isActive =
          leaf !== null &&
          entry.paneId === focusedId &&
          leaf.activeTabIdx === entry.tabIdx;
        return (
          <PaletteItem
...
export function useCommandPalette() {
  ...
  return {
    open: state.open,
    mode: state.mode,
    setOpen: (open: boolean, mode: PaletteMode = 'all') =>
      setState({ open, mode }),
  };
}
