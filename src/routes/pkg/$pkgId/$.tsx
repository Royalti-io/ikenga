    ...
    return (
      <div className="p-6 text-sm">
        ...
        <div className="opacity-70">
          <code>pkg://{pkgId}{state.routePath}</code> is not registered. The
          package may have been uninstalled, or this URL is stale.
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="p-6 text-sm">
        ...
        <div className="opacity-70">
          ...
          component-kind routes are reserved for host-builtin marker installs.
        </div>
      </div>
    );
  }
