...
export function postToIframeFireAndForget(
  paneId: string,
  kind: string,
  payload: unknown,
): void {
...
export function requestIframeWait(
  ...
  return postWithReply(paneId, 'wait-request', { kind, value, timeout_ms: timeoutMs }, timeoutMs + 1500);
}
...
function findRegistrationByWindow(source: MessageEventSource | null): IframeRegistration | undefined {
