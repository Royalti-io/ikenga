...
const CodeView = lazy(() =>
  import("./renderers/code-view").then((m) => ({ default: m.CodeView })),
);
const PdfView = lazy(() =>
  import("./renderers/pdf-view").then((m) => ({ default: m.PdfView })),
);
const XlsxView = lazy(() =>
  import("./renderers/xlsx-view").then((m) => ({ default: m.XlsxView })),
);
